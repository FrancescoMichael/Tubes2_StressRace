...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center p-24 flex-wrap">
      <div data-aos="fade-right" className="flex flex-row flex-wrap justify-center gap-4 items-center h-full animate-fadeIn">
        <div>
      ...
      <div data-aos="fade-left" className="flex flex-row flex-wrap justify-center gap-4 items-center h-full mt-12 animate-fadeIn">
        <span className="text-white text-lg text-justify w-8/12">
      ...
      <div data-aos="fade-up" className="text-white text-lg text-justify mt-12">
